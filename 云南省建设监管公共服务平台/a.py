...
def second_encrypt(message):
    # 获取当前文件路径
    current_dir = os.path.dirname(os.path.abspath(__file__))
    js_code = ''
    with open(current_dir + '/a.js', 'r', encoding='utf-8') as f:
        js_code = f.read()

    js = execjs.compile(js_code, cwd=r"/Users/flyeyas/items/tuling/src/node_modules")
    result = js.call('V_e', message)
    return result

print(second_encrypt('FnQXKsRv5WTfL5JYWvwVsw=='))
